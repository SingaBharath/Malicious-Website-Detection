...
| **Defacement** | Website content has been illegitimately altered |
...
| 2 | **Trusted Domain Whitelist** | 50+ verified safe domains always marked Safe |
| 3 | **Live URL Reachability** | Checks if website actually exists on internet |
| 4 | **Suspicious Pattern Analysis** | IP URLs, free bad TLDs (.tk, .ml), phishing keywords |
...
The model was originally trained and analyzed in Google Colab.

[Open in Google Colab](https://colab.research.google.com/drive/12yb-4tviLJBvU3bgDr_GPQMu7UYGIkDl?usp=sharing)
...
Made with love by [SingaBharath](https://github.com/SingaBharath)
